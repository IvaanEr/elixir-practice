defmodule GroceryStoreWeb.ProductControllerTest do
  use GroceryStoreWeb.ConnCase

  alias GroceryStore.Store

  @create_attrs %{description: "some description", price: 42, stock: 42, title: "some title"}
